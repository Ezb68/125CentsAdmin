                                                ...
                                                <nav>
                                                    <ul className="nav nav-pills mb-3" id="pills-tab">
                                                        <li className="nav-item me-3 me-lg-4">
                                                            <div className="nav-link active">FG/LG</div>
                                                        </li>
                                                    </ul>
                                                </nav>
                                            </div>
                                                    ...
                                                    <div className="head-box my-4 p-3">
                                                        <div className="d-flex align-items-center">
                                                            <div className="px-0 w-100">
                                                                ...
                                                                <div className="fs-5 text-light">Refesh</div>
                                                            </div>
                                                            <div className="flex-shrink-1">
                                                                <div className="head-icon">
                                            ...
                                            <div className="table-responsive">
                                                <table className="table table-bordered mb-0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th className="align-middle" scope="col" rowSpan="2">No Goal
                                                        </th>
                                                    </tr>
                                                    <tr>
