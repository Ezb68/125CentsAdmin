...
export default function OnexTow() {
    return (
        <>
                                    ...
                                    <div className="row mx-0">
                                        <div className="col-lg-6 mb-3 mb-lg-0">
                                                ...
                                                <nav>
                                                    <ul className="nav nav-pills mb-3" id="pills-tab">
                                                        <li className="nav-item me-3 me-lg-4">
                                                            <div className="nav-link active">1X2</div>
                                                        </li>
                                                    </ul>
                                                </nav>
                                            </div>
                                            <div className="row mx-0">
                                                ...
                                                <div className="col-lg-4 mt-3">
                                                    <div className="input-group"><select className="form-select" aria-label="Default select example">
