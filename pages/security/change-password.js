                            ...
                            <div className="card border-0 shadow bg-transparent">
                                <div className="card-header bg-white pt-0 pb-3 pb-lg-4 border-0 mb-1">
                                    <div className="d-flex justify-content-center">
                                        <div className="title-block px-4 py-3">Change Password</div>
                                    </div>
                                </div>
                                <div className="card-body bg-white">
                                    <div className="px-5 py-3">
                                        ...
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div className="px-2">Your password length must between 6-20 characters
                                            </div>
                                        </div>
                                        <div className="d-flex align-items-center">
                                            <div className="flex-shrink-1">
                                                <img className="policy-icon" src={remove.src}/></div>
                                            <div className="px-2">Your password must include a combination of characters
                                                (uppercase or lowercase letters) and numbers
                                            </div>
                                        </div>
                                    </div>
                                    <div className="row mx-0">
                                        ...
                                        <div className="box py-2 mb-1 rounded-0 box-light">
                                            <div className="row mx-0">
                                                <div className="col-4">
                                                    <div className="d-flex align-items-center h-100">New Password :
                                                        <div className="text-danger">*</div>
                                                    </div>
                                                </div>
                                                <div className="col-8">
                                        ...
                                        <div className="box py-2 mb-1 rounded-0">
                                            <div className="row mx-0">
                                                <div className="col-4">
                                                    <div className="d-flex align-items-center h-100">Confirm Password
                                                        :
                                                    </div>
                                                </div>
                                                <div className="col-8">
                                ...
                                <div className="row mx-0">
                                    <div className="col-lg-11 mx-auto">
                                        <div className="d-flex justify-content-end py-3">
                                            ...
                                            <button className="btn btn-greate hvr-grow ms-4">Change Password</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
